                                                             ...
                                                             <td align="center">
                                                                 ...
                                                                 <div class="btn-group">
                                                                     ...
                                                                     <ul class="dropdown-menu pull-right">
                                                                         ...
                                                                         {!!Form::open(array('url' => 'laracancan/lccresourcepermission/'.$permission->permission->id, 'method' => 'delete', 'id'=>'delete_resourcepermission_'.$resource->id.'_'.$permission->permission->id))!!}
