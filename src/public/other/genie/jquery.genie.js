...
(function($, window, document, undefined){
	...
	$.fn.genieExpand = function(target, directions, step_quantum, callback,callback2){
		window.genie.expand(this[0], target[0], directions, step_quantum, callback,callback2);
		return this;
	};
